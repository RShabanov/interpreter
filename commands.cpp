...
void Cmd::cmd_print() {
	...
	if (token[0] == '(') {
		...
		out_string(result_str); // ïîäãîòîâèòü ñòðîêó ê âûâîäó
...
void Cmd::cmd_input() {
	// îãðàíè÷èìñÿ ïîêà ââîäîì double
...
void Cmd::cmd_let() {
	// íà âõîä program óêàçûâàåò íà "var = 5"
...
void FunFunctor::add_fun_vars(std::vector<double>& values) {
	// ñîïîñòàâëÿåò ïåðåìåííûå ñî çíà÷åíèÿìè
	// (let a, b, c)
	// (	1, 2, 3), e.g.
	// ò.ê. ïðîâåðêà íà êîððåêòíîñòü ôîðìû
	// ïðîèñõîäèò ïåðåä äàííîé ôóíêöèåé,
	// òî çäåñü åå ìîæíî îïóñòèòü
